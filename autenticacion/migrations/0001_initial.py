    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(blank=True, choices=[('indefinido', 'Indefinido'), ('discotequero', 'Discotequero'), ('fiestero', 'Fiestero')], default='indefinido', max_length=20, null=True, verbose_name='tipo')),
